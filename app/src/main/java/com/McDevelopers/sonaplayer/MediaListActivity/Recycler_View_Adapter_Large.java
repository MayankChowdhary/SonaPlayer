...
public class Recycler_View_Adapter_Large extends RecyclerView.Adapter<View_Holder_Large> implements SectionIndexer {
   ...
   private DrawableCrossFadeFactory factory ;
    ...
    public Recycler_View_Adapter_Large(List<Data> list, Context context) {
        this.list = list;
    ...
    @Override
    public View_Holder_Large onCreateViewHolder(ViewGroup parent, int viewType) {
        //Inflate the layout, initialize the View Holder
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_layout, parent, false);
        View_Holder_Large holder = new View_Holder_Large(v);
        return holder;
    }

    @SuppressLint("SetTextI18n")
    @Override
    public void onBindViewHolder(View_Holder_Large holder, int position) {
        ...
        holder.songMeta.setText(timeConvert(list.get(position).duration) + " | " + getSongFormat(list.get(position).data)+" | "+list.get(position).size);
