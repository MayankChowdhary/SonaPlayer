...
public class Recycler_View_Adapter_Small extends RecyclerView.Adapter<View_Holder_Small> implements SectionIndexer {
  ...
  public   List<Data> list ;
    ...
    public Recycler_View_Adapter_Small(List<Data> list, Context context) {
        this.list = list;
    ...
    @Override
    public View_Holder_Small onCreateViewHolder(ViewGroup parent, int viewType) {
        //Inflate the layout, initialize the View Holder
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_layout_small, parent, false);
        View_Holder_Small holder = new View_Holder_Small(v);
        return holder;

    }

    @Override
    public void onBindViewHolder(View_Holder_Small holder, int position) {
        ...
        holder.description.setText(timeConvert(list.get(position).duration) + " | " + getSongFormat(list.get(position).data)+" | "+list.get(position).size);
