...
public class Recycler_View_Adapter_Grid_R extends RecyclerView.Adapter<View_Holder_Grid_R> implements SectionIndexer {
    ...
    public Recycler_View_Adapter_Grid_R(List<RecentData> list, Context context) {
        this.list = list;
    ...
    @Override
    public View_Holder_Grid_R onCreateViewHolder(ViewGroup parent, int viewType) {
        //Inflate the layout, initialize the View Holder
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.gridlist_item, parent, false);
        View_Holder_Grid_R holder = new View_Holder_Grid_R(v);
        return holder;

    }

    @Override
    public void onBindViewHolder(View_Holder_Grid_R holder, int position) {
        ...
        holder.audio_meta.setText(timeConvert(list.get(position).duration) + " | " + getSongFormat(list.get(position).data)+" | "+list.get(position).date);
