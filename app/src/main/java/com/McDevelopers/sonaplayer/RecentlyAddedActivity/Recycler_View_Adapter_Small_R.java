...
public class Recycler_View_Adapter_Small_R extends RecyclerView.Adapter<View_Holder_Small_R> implements SectionIndexer {
  ...
  public   List<RecentData> list ;
    ...
    public Recycler_View_Adapter_Small_R(List<RecentData> list, Context context) {
        this.list = list;
    ...
    @Override
    public View_Holder_Small_R onCreateViewHolder(ViewGroup parent, int viewType) {
        //Inflate the layout, initialize the View Holder
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_layout_small, parent, false);
        View_Holder_Small_R holder = new View_Holder_Small_R(v);
        return holder;

    }

    @Override
    public void onBindViewHolder(View_Holder_Small_R holder, int position) {
        ...
        holder.description.setText(timeConvert(list.get(position).duration) + " | " + getSongFormat(list.get(position).data)+" | "+list.get(position).date);
       // holder.imageView.setImageBitmap(artwork);
