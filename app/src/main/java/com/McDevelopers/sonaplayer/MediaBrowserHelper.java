...
public class MediaBrowserHelper {
     ...
     * any connections to the {@link SonaHeartService} happens via the {@link MediaSessionCompat}.
     */
    ...
    // MediaBrowserService (SonaHeartService).
    private class MediaBrowserConnectionCallback extends MediaBrowserCompat.ConnectionCallback {
        ...
        public void onConnected() {
            try {
                ...
                Log.d(TAG, "onConnected: Start Creating MediaBrowser, and connecting");
                mMediaController =
                ...
                Log.d(TAG, "onConnected:End Creating MediaBrowser, and connecting");
    ...
    private class MediaControllerCallback extends Callback {
        ...
        // This might happen if the SonaHeartService is killed while the Activity is in the
