...
public class FolderExpandChildHolder extends ChildViewHolder {
    ...
    public FolderExpandChildHolder(View itemView) {
        super(itemView);
    ...
    public void setChildAlbumArt(String artId ,boolean checkFlag,boolean isVideo) {
        if (isCustomArt && MusicLibrary.listOfAllImages.size()!=0 && !isVideo && !checkFlag) {
            GlideApp
            ...
            GlideApp
                    ...
                    .placeholder(R.drawable.folderitem)
                    .error(R.drawable.folderitem)
                    .diskCacheStrategy(DiskCacheStrategy.AUTOMATIC)
                    .into(icon);
            ...
            GlideApp
                    .with(icon.getContext())
                    .asBitmap()
                    .load(Uri.fromFile(new File(artId)))
                    .dontAnimate()
                    .placeholder(R.drawable.loading_art)
                    .error(R.drawable.loading_art)
                    .diskCacheStrategy(DiskCacheStrategy.AUTOMATIC)
